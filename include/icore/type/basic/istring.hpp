        ...
        namespace type {
            namespace basic {
                ...
                public:
                    ...
                    size_type indexOf(const istring& str, size_type pos = 0) const
                    {
                        return this->_data.find(str._data, pos);
                    }
                    ...
                    size_type indexOf(const value_type* s, size_type pos, size_type count) const
                    {
                        return this->_data.find(s, pos, count);
                    }
                    ...
                    size_type indexOf(const value_type* s, size_type pos = 0) const
                    {
                        return this->_data.find(s, pos);
                    }
                    ...
                    size_type indexOf(value_type ch, size_type pos = 0) const
                    {
                        return this->_data.rfind(ch, pos);
                    }
                    ...
                    size_type lastIndexOf(const istring& str, size_type pos = istring::npos) const
                    {
                        return this->_data.rfind(str._data, pos);
                    }
                    ...
                    size_type lastIndexOf(const value_type* s, size_type pos, size_type count) const
                    {
                        return this->_data.rfind(s, pos, count);
                    }
                    ...
                    size_type lastIndexOf(const value_type* s, size_type pos = istring::npos) const
                    {
                        return this->_data.rfind(s, pos);
                    }
                    ...
                    size_type lastIndexOf(value_type ch, size_type pos = istring::npos) const
                    {
                        return this->_data.rfind(ch, pos);
                    }

                    /// <summary>
                    /// hash code with istring
                    /// </summary>
                    size_type hashCode() const
                    {
                        return std::hash<Type>{}(this->_data);
                    }
                    ...
                    std::match_results<const value_type*> matchResult(const std::basic_regex<value_type>& regex,
                                                                      bool search = false)
                    {
                ...
                public:
                    ...
                    /// </summary>
                    template <typename T>
                    static inline istring valueOf(T&& value)
                    {
#ifdef __CPP_17__
                    ...
                    /// <summary>
                    /// char and string convert
                    /// </summary>
                    static inline std::wstring str2WideStr(const std::string& str)
                    {
                        std::wstring_convert<std::codecvt<wchar_t, char, std::mbstate_t>> convert;
                        return convert.from_bytes(str);
                    }

                    static inline std::wstring str2WideStr(char ch)
                    {
                        std::wstring_convert<std::codecvt<wchar_t, char, std::mbstate_t>> convert;
                        return convert.from_bytes(ch);
                    }

                    static inline std::wstring str2WideStr(const char* str)
                    {
                        std::wstring_convert<std::codecvt<wchar_t, char, std::mbstate_t>> convert;
                        return convert.from_bytes(str);
                    }

                    static inline std::string wideStr2Str(const std::wstring& str)
                    {
                        std::wstring_convert<std::codecvt<wchar_t, char, std::mbstate_t>> convert;
                        return convert.to_bytes(str);
                    }

                    static inline std::string wideStr2Str(wchar_t ch)
                    {
                        std::wstring_convert<std::codecvt<wchar_t, char, std::mbstate_t>> convert;
                        return convert.to_bytes(ch);
                    }

                    static inline std::string wideStr2Str(const wchar_t* str)
                    {
                        std::wstring_convert<std::codecvt<wchar_t, char, std::mbstate_t>> convert;
                        return convert.to_bytes(str);
                    }
                    ...
                    static inline bool isWideCharHex(wchar_t wch)
                    {
